          ...
          <div className="ba-modal-body">
            <form action="submit" className="ba-auth-form">
              <label htmlFor="login" className="ba-label ba-auth-form-label">
                Login
                <input type="text" name="login" id="login" className="ba-input ba-auth-form-input" />
              </label>
              <label htmlFor="password" className="ba-label ba-auth-form-label">
                Password
                <input type="password" name="password" id="password" className="ba-input ba-auth-form-input" />
              </label>
              <div className="ba-auth-form-buttons">
                <button className="ba-button ba-button--primary">Sign in</button>
